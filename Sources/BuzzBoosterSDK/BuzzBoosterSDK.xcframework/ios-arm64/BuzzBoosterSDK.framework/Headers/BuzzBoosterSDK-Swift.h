...
SWIFT_CLASS("_TtC14BuzzBoosterSDK17CampaignEntryView")
@interface CampaignEntryView : UIView
@property (nonatomic, copy) NSArray<UIView *> * _Nonnull clickableViews;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)setEntryName:(NSString * _Nonnull)entryName;
@end


SWIFT_CLASS("_TtC14BuzzBoosterSDK31BSTCampaignFloatingActionButton")
@interface BSTCampaignFloatingActionButton : CampaignEntryView
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, weak) id <BSTUserEventDelegate> _Nullable userEventDelegate;)
+ (id <BSTUserEventDelegate> _Nullable)userEventDelegate SWIFT_WARN_UNUSED_RESULT;
+ (void)setUserEventDelegate:(id <BSTUserEventDelegate> _Nullable)value;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
